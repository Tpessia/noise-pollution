...
.directive('youtubeVideo', ['$window', 'youtubeEmbedUtils', function ($window, youtubeEmbedUtils) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            function loadPlayer () {
                if (scope.videoId || scope.playerVars.list || scope.playerVars.playlist) {
            ...
            var stopWatchingReady = scope.$watch(
                function () {
                    return scope.utils.ready
                        ...
                        ||  typeof scope.playerVars.playlist !== 'undefined');
                },
                function (ready) {
                    if (ready) {
                        stopWatchingReady();
                        ...
                        // finally, a list
                            ...
                            if (typeof scope.playerVars.playlist !== 'undefined') {
                                scope.$watch('playerVars.playlist', function () {
                                    scope.urlStartTime = null;
                                    loadPlayer();
                                });
                            } 
